...
export const scheduleApi = {
  ...
  bulk: (entries) => api('/api/schedule/bulk', { method: 'POST', body: { entries } }),
  daily: (year, month, day) => api(`/api/schedule/daily?year=${year}&month=${month}&day=${day}`),
  summary: (year, month) => api(`/api/schedule/summary?year=${year}&month=${month}`),
...
export const usersApi = {
  list: () => api('/api/users'),
  setRole: (id, role) => api(`/api/users/${id}/role`, { method: 'PATCH', body: { role } }),
